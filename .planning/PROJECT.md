...
- **v0.4** — Reference audit — 12 phases complete (Header, Search Palette, Section Order, Hero, Podcasts, Book, Speaking, Presentations, Blog, Contact, Logo/Favicon, Footer). Live site now matches the Deep Signal reference UI kit across every homepage section.
