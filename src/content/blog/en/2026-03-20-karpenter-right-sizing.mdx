...
<figure class="my-6">
  ...
  />
  <figcaption class="text-sm text-text-muted mt-2 text-center">Split ownership — Cluster Autoscaler handles system node groups on on-demand nodes; Karpenter handles the stateless fleet on dynamic nodes, separated by taints and tolerations.</figcaption>
</figure>
