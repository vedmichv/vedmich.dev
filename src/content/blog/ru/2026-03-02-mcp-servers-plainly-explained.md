...
<figure class="my-6">
  ...
  />
  <figcaption class="text-sm text-text-muted mt-2 text-center">Топология клиент-сервер MCP — Claude Code подключается к MCP-серверу, который маршрутизирует запросы к внешним ресурсам.</figcaption>
</figure>
