...
<figure class="my-6">
  ...
  />
  <figcaption class="text-sm text-text-muted mt-2 text-center">Разделение ownership — Cluster Autoscaler управляет system node groups на on-demand нодах; Karpenter управляет stateless fleet на динамических нодах, разграничение через taints и tolerations.</figcaption>
</figure>
